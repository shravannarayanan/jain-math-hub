          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto space-y-4">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur rounded-full px-4 py-2">
                ...
                <span className="text-sm font-medium">Grade 12 / Plus Two</span>
              </div>
              <h1 className="text-4xl md:text-5xl font-bold">Plus Two Mathematics</h1>
              <p className="text-lg opacity-90">
                Complete course covering all 13 chapters of Plus Two Mathematics with detailed video explanations
              </p>
